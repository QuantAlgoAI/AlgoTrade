...
# Set the source directory dynamically (current script directory)
SOURCE_DIR = os.path.dirname(os.path.abspath(__file__))

# Set the main backup directory
BACKUP_BASE_DIR = r"D:\Backup\Cursor_AI"
...
def backup_project():
    """Backup the project folder by creating a new ZIP archive with a timestamp."""
